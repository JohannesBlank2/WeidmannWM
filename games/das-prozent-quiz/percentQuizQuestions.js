...
const PERCENT_QUIZ_QUESTIONS = [
  {
    ...
    multiplier: 2,
    visual: 'photo',
    fallbackVisual: 'diagram',
    imageSrc: '/assets/games/prozentquiz/25-question.png',
    solutionImageSrc: '/assets/games/prozentquiz/25-solution.png',
    answerType: 'choice',
    options: [
      { value: '1', label: '1' },
      { value: '2', label: '2' },
  ...
  },
  {
    ...
    multiplier: 3,
    visual: 'note',
    imageSrc: '/assets/games/prozentquiz/10-note.png',
    answerType: 'choice',
    options: [
      { value: 'A', label: 'Anke' },
      { value: 'B', label: 'Bert' },
  ...
  },
  {
    ...
    multiplier: 4,
    visual: 'photo',
    imageSrc: '/assets/games/prozentquiz/1-question.png',
    answerType: 'number',
    options: [],
    correctAnswer: '26',
    questionText:
